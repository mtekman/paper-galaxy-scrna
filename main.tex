...
%% Question: Terminologoy - Pipeline, Suite, Workflow, which to use?
...
Analyses are not limited to one tool pipeline either, as the datasets which are passed between tools can easily be interpreted by a different tool which is capable of reading that dataset. In the case of scRNA-seq, Galaxy makes good use of the \fileformat{LOOM} and \fileformat{AnnData}
...
% STARsolo compared to CellRanger
