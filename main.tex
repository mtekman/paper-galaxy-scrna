...
The teaching and training materials are part of the Galaxy Training Network (GTN) which is a worldwide collaborative effort to produce high-quality teaching material to .

The recent iteration of Galaxy allows subdomains that better encapsulate the various topics into their own infospheres, such that only the relevant tools are shown in the tool window for a given topic, in order to make Galaxy much more portable.
